...
# Verificar si existe la columna 'Clima' y aplicar la clasificación
...
# Determinar el palo recomendado
...
# Codificación de la ubicación de bandera y palo recomendado
...
# Crear los modelos de Random Forest
...
# Calcular los porcentajes de mejora
...
def get_ranking():
    # Obtener el parámetro 'hoyos' (puede ser 9 o 18)
    hoyos = request.args.get('hoyos', default='18', type=str)  # '18' por defecto si no se pasa nada

    if hoyos == "9":
        # Filtrar jugadores de los primeros 9 hoyos
        ...
        ranking_9_top = ranking_9.head(10)  # Top 10 jugadores de los primeros 9 hoyos
    else:
        ranking_9_top = pd.DataFrame()  # Asegurarse de que sea un DataFrame vacío si no hay ranking 9

    # Filtrar jugadores que hayan jugado todos los 18 hoyos
    ...
    ranking_18_top = ranking_18.head(10)  # Top 10 jugadores de los 18 hoyos completos
